...
class SelectPurpose(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.label = ctk.CTkLabel(frame, text='利用用途確認', font=('Times', 30))
        self.label.place(x=50, y=50)
        
        self.stay_button = ctk.CTkButton(frame, text="宿泊", command=self.stay_event,font=('Times',40),width=300,height=300 )
        self.stay_button.place(x=130, y= 130)
        
        self.banquet_button = ctk.CTkButton(frame, text="宴会", command=self.banquet_event,font=('Times',40),width=300,height=300 )
