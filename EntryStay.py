...
class EntryStay(ctk.CTkFrame):
    ...
    def create_widget(self):
        ...
        # フレームの作成
        base_frame = ctk.CTkFrame(self.master, width=1225, height=555)
        base_frame.place(x=15, y=75)
        self.canvas = ctk.CTkCanvas(base_frame, highlightthickness=0)
        self.canvas.pack(side='left', fill='both', expand=True)
        self.scrollbar = ctk.CTkScrollbar(base_frame, orientation='horizontal', command=self.canvas.xview)
